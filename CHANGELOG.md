...
## [0.0.0-beta.7] - 2026-02-05
### Added
- Add one line in `SUPPORT` to the file to guide to our official discussion group.

## [0.0.0-beta.6] - 2026-02-05
### Added
- adding `CONTRIBUTING`.
- adding `SUPPORT`.
### Changed
- We're about to checkout the `develop` branch!

## [0.0.0-beta.5] - 2026-02-05
### Added
